        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header row">
              ...
              <a href="index.php?act=category-create" class="col-2 btn btn-primary"><i
                  class="fa-solid fa-plus"></i> Thêm danh mục</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                  <?php foreach ($listCategories as $value) { ?>
                    <tr>
                      ...
                      <td><?= $value['name'] ?></td>
                      <td>
                        <img src="./images/category/<?= $value['image'] ?>" alt=""
                      ...
                      <td>
                        ...
                        <a title="Xóa" onclick="return confirm('Bạn chắc chắn muốn xóa không ?')"
                          href="index.php?act=category-delete&id=<?= $value['id'] ?>">
