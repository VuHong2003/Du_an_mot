    ...
    <div class="center home">
        <section class="hero_section">
            <div class="img_home_banner">
                <a href=""><img src="../public/images/logo/dark.png" alt="" class="image text-center"></a>
            </div>
        </section>
<!-- /* ==========================  ========================== */ -->
                ...
                <a href="">
                    <div class="box_swiper">
                        <div class="box_img_categories">
                            <img src="../public/images/logo/dark.png" alt="" class="image text-center">
                        </div>
                        <div class="name_categories">Vegetable</div>
                    </div>
                </a>
            </div>
        </section>
            ...
            <div class="popular_items">
                <div class="flex_popular">
                    <div class="box_popular">
                        <div class="item_img">
                            <img src="../public/images/logo/dark.png" alt="" class="img_home_prd image text-center">
...
<!-- /* ==========================  ========================== */ -->        
        <section>
            <div class="f_item_pro flex">
                <div class="flex_end">
                    <div><img src="../public/images/logo/dark.png" alt="" class="item_img_pro img_home_prd image text-center"></div>
