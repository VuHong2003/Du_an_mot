...
<head>
    ...
    <!-- Thêm liên kết Bootstrap hoặc các thư viện JS, CSS tại đây nếu cần -->
                ...
                <div class="container-fluid">
                    ...
                    <form action="?act=sua-lien-he" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" value="<?= htmlspecialchars($lien_he['fullname']) ?>" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="phone" value="<?= htmlspecialchars($lien_he['phone']) ?>" readonly>
                        </div>
